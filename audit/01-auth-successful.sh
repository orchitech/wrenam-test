...
assert_audit_file_content $EXPECTED_INCREMENT "AM-LOGIN-MODULE-COMPLETED.*SUCCESSFUL"
assert_audit_file_content $EXPECTED_INCREMENT "AM-LOGIN-COMPLETED.*SUCCESSFUL"
